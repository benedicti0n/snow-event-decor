...
const SmallInfoSection = () => {
    return (
        <div className='w-full flex flex-col justify-center items-center font-bacasime text-2xl md:text-3xl text-center pt-12 md:pt-20 px-8 bg-background'>
            ...
            <h1 className='mt-4 flex items-center justify-center gap-2 text-2xl md:text-3xl'><LucideInstagram /><a href='https://www.instagram.com/snow_decor_/' target="_blank" rel="noopener noreferrer"> @snow_decor</a></h1>
